...
# Fix Java problem for burpsuite
export _JAVA_AWT_WM_NONREPARENTING=1



source /home/jrt/powerlevel10k/powerlevel10k.zsh-theme
...
function settarget(){
    ip_address=$1
    machine_name=$2
    echo "$ip_address $machine_name" > /home/jrt/.config/bin/target
}

# Clear Victim Target

function cleartarget(){
    echo '' > /home/jrt/.config/bin/target
}

function mkt(){
	mkdir scripts scanning content
}
